...
La corruzione logica può essere causata da errori software, errori umani o sabotaggio. Sfortunatamente, la corruzione logica spesso non può essere affrontata con le soluzioni standard di alta disponibilità e disaster recovery. Di conseguenza, a seconda del livello, dell'applicazione, del file system o dello storage in cui si è verificata la corruzione logica, i requisiti massimi di downtime e perdita di dati talvolta non possono essere soddisfatti.
...
https://www.netapp.com/pdf.html?item=/media/8584-tr4646pdf.pdf["Disaster recovery SAP HANA con replica dello storage"]

link:../backup/hana-dr-anf-data-protection-overview.html["Disaster recovery per SAP HANA con Azure NetApp Files"]
