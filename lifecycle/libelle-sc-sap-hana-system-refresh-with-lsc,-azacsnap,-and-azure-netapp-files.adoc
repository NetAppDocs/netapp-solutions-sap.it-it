...
image:libelle-sc-image31.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:libelle-sc-image32.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:libelle-sc-image33.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]

LSC inizia a eseguire le attività della fase di verifica, seguite dalle attività configurate della fase preliminare.

image:libelle-sc-image34.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:libelle-sc-image35.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:libelle-sc-image36.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]

image:libelle-sc-image37.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:libelle-sc-image38.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:libelle-sc-image39.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
