...
Per maggiori dettagli su questi diversi agenti SnapCenter e sulle opzioni di installazione del plug-in del database SAP HANA, consultare il report tecnico link:../backup/hana-sc-generic-scope.html["Backup e recovery SAP HANA con SnapCenter"^].
...
Per eseguire un backup automatico basato su copia Snapshot dal database di origine e creare un clone per il nuovo database di destinazione, l'integrazione descritta tra LSC e SnapCenter utilizza le opzioni di configurazione e gli script descritti in link:sc-copy-clone-introduction.html["Automazione delle operazioni di copia e clonazione del sistema SAP HANA con SnapCenter"^].
...
* https://www.netapp.com/pdf.html?item=/media/12403-tr4700.pdf["SnapCenter Plug-In per Oracle Database"^]
* link:../backup/hana-sc-generic-scope.html["Backup e ripristino SAP HANA con SnapCenter"^]
* link:sc-copy-clone-introduction.html["Automazione delle operazioni di copia e clonazione del sistema SAP HANA con SnapCenter"^]
