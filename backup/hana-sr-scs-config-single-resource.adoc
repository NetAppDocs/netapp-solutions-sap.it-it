...
....
Ulteriori informazioni sulle opzioni di distribuzione del plug-in SAP HANA e sulla configurazione dell'archivio utenti sono disponibili nel report tecnico TR-4614: link:hana-sc-generic-scope.html["Backup e ripristino SAP HANA con SnapCenter"^].
