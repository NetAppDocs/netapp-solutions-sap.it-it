...
....
Puoi trovare ulteriori informazioni sulle opzioni di distribuzione del plug-in SAP HANA e sulla configurazione dello user store in link:hana-sc-generic-scope.html["Backup e ripristino SAP HANA con SnapCenter"^].
