...
....
Per ulteriori informazioni sulle opzioni di implementazione dei plug-in SAP HANA e sulla configurazione dell'archivio utenti, consulta il report tecnico TR-4614: https://docs.netapp.com/us-en/netapp-solutions-sap/backup/saphana-br-scs-overview.html["Backup e ripristino SAP HANA con SnapCenter"^].
