...
link:saphana-dr-anf_configuration_steps_for_anf_cross-region_replication.html["Precedente: Procedura di configurazione per la replica ANF Cross-Region."]
...
link:saphana-dr-anf_disaster_recovery_testing_overview.html["Successivo: Test di disaster recovery."]
