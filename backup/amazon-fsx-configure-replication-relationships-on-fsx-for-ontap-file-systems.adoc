...
link:amazon-fsx-backup-replication-with-snapvault_overview.html["Precedente: Panoramica - replica di backup con SnapVault."]
...
sapcc-hana-svm:PFX_data_mnt00001
            XDP  sapcc-backup-target-zone5:PFX_data_mnt00001
                              Snapmirrored
                                      Idle           -         true    -
....
link:amazon-fsx-add-a-backup-svm-to-snapcenter.html["Avanti: Aggiungere una SVM di backup a SnapCenter."]
