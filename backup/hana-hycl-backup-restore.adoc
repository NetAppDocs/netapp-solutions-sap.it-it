...
. Fare clic su *Visualizza dettagli* corrispondente al database che si desidera ripristinare. + image:hana-hycl-back-image38.jpeg["hana-hycl-back-image38, larghezza=624, altezza=305"]
. Selezionare il backup desiderato e scegliere esportazione archiviazione. + image:hana-hycl-back-image39.jpeg["larghezza=624,altezza=308"]
. Fornire le opzioni desiderate: + image:hana-hycl-back-image40.jpeg["larghezza=624,altezza=308"]
+
