...
link:saphana-dr-anf_create_new_volumes_based_on_snapshot_backups_at_the_disaster_recovery_site.html["Precedente: Creazione di nuovi volumi in base ai backup snapshot nel sito di disaster recovery."]
...
....
link:saphana-dr-anf_hana_database_recovery.html["Successivo: Ripristino del database HANA."]
