...
link:saphana-dr-anf_mount_the_new_volumes_at_the_target_host.html["Precedente: Montare i volumi sull'host di destinazione."]
...
link:saphana-dr-anf_disaster_recovery_failover_overview.html["Successivo: Failover del disaster recovery."]
