...
link:saphana-br-scs-snapcenter-sap-hana-backup-solution.html["Precedente: Soluzione di backup SAP HANA di SnapCenter."]
...
|===
link:saphana-br-scs-lab-setup-used-for-this-report.html["Segue: Impostazione di laboratorio utilizzata per questo report."]
