...
link:saphana-dr-anf_prepare_the_target_host_01.html["Precedente: Preparare l'host di destinazione."]
...
link:saphana-dr-anf_mount_the_volumes_at_the_target_host.html["Avanti: Montare i volumi sull'host di destinazione."]
