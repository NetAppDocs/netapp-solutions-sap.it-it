...
link:saphana-sr-scs-restore-and-recovery-from-a-backup-created-at-the-other-host.html["Precedente: Ripristino e ripristino da un backup creato sull'altro host."]
...
link:saphana-sr-scs-version-history.html["Pagina successiva: Cronologia delle versioni."]
