...
link:hana-sc-generic-scope.html["Backup e recovery SAP HANA con SnapCenter"]

link:hana-sr-scs-system-replication-overview.html["Replica di sistema SAP HANA - backup e recovery con SnapCenter"]
