...
NOTE: È supportato il ripristino dal volume ANF primario. Il ripristino del backup ANF non è ancora supportato. Un ripristino sul posto o un ripristino su un nuovo volume da un backup ANF deve essere eseguito manualmente tramite il portale di Azure o l'interfaccia della riga di comando.
