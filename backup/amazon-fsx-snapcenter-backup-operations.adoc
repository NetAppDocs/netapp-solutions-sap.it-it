...
link:amazon-fsx-snapcenter-configuration.html["Precedente: Configurazione SnapCenter."]
...
hana-1:~ #
....
link:amazon-fsx-backup-of-non-data-volumes.html["Avanti: Backup di volumi non dati."]
