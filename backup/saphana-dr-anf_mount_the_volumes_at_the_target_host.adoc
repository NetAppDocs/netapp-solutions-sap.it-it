...
summary: 'I volumi possono ora essere montati sull"host di destinazione, in base a. `/etc/fstab` file creato in precedenza.' 
---
...
link:saphana-dr-anf_break_and_delete_replication_peering.html["Precedente: Interrompere ed eliminare il peering della replica."]
...
vm-pr1:~ #
....
link:saphana-dr-anf_hana_database_recovery_01.html["Successivo: Ripristino del database HANA."]
