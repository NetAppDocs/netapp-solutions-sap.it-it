...
Per informazioni dettagliate sulla soluzione di backup e ripristino SAP HANA, vedere link:../backup/hana-sc-generic-scope.html["Backup e ripristino SAP HANA con SnapCenter"^].
