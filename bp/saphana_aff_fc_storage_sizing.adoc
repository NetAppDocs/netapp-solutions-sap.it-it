...
link:saphana_aff_fc_architecture.html["Precedente: Architettura."]
...
Il numero minimo di SSD NVMe da 12 GB per il primo shelf supporta fino a 18 host SAP HANA. Uno shelf completamente popolato supporta fino a 48 host SAP HANA.
...
image:saphana_aff_fc_image8.jpg["Errore: Immagine grafica mancante"]

link:saphana_aff_fc_infrastructure_setup_and_configuration_overview.html["Pagina successiva: Configurazione e configurazione dell'infrastruttura."]
