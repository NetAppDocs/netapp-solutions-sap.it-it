...
link:saphana_aff_nfs_infrastructure_setup_and_configuration_overview.html["Precedente: Configurazione e configurazione dell'infrastruttura."]
...
link:saphana_aff_nfs_time_synchronization.html["Successivo: Sincronizzazione dell'ora."]
