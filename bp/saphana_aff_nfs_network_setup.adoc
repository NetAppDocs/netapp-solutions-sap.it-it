...
image::saphana_aff_nfs_image10.png[safana AFF nfs image10]
...
image::saphana_aff_nfs_image11.png[safana AFF nfs image11]
...
image::saphana_aff_nfs_image12.png[safana AFF nfs image12]
