...
link:saphana_fas_fc_time_synchronization.html["Precedente: Sincronizzazione dell'ora."]
...
L'utilizzo di NetApp Volume Encryption (NVE) è supportato per SAP HANA.
...
link:saphana_fas_fc_sap_hana_storage_connector_api.html["Successivo: API del connettore di storage SAP HANA."]
