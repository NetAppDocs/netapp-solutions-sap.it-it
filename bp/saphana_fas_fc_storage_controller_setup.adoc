...
image:saphana_fas_fc_image13.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:saphana_fas_fc_image14.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:saphana_fas_fc_image15.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:saphana_fas_fc_image16.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:saphana_fas_fc_image17.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:saphana_fas_fc_image18.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:saphana_fas_fc_image19.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
+
image:saphana_fas_fc_image20.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]

. Immettere il nome del LUN, selezionare il tipo di LUN e immettere le dimensioni del LUN.
+
image:saphana_fas_fc_image21.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]

. Inserire il nome del volume e l'aggregato di hosting.
+
image:saphana_fas_fc_image22.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]

. Selezionare gli igroups a cui devono essere mappati i LUN.
+
image:saphana_fas_fc_image23.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]

. Fornire le impostazioni QoS.
+
image:saphana_fas_fc_image24.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]

. Fare clic su Avanti nella pagina Riepilogo.
+
image:saphana_fas_fc_image25.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]

. Fare clic su fine nella pagina completamento.
+
image:saphana_fas_fc_image26.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
+
image:saphana_fas_fc_image27.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
