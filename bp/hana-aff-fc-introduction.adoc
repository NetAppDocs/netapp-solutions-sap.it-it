...
La famiglia di prodotti NetApp AFF/ ASA A-Series è stata certificata per l'utilizzo con SAP HANA in progetti di integrazione di data center personalizzati (TDI).
...
* https://help.sap.com/docs/SAP_HANA_PLATFORM/eb3777d5495d46c5b2fa773206bbfb46/0b15a92d554c4941a452c9ca127f8c70.html["Integrazione SAP HANA Tailored Data Center"^]
