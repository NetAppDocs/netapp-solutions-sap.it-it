...
link:saphana_aff_fc_time_synchronization.html["Precedente: Sincronizzazione dell'ora."]
...
. Creare gruppi di iniziatori, volumi e LUN all'interno degli aggregati, come descritto in creazione di "<<LUNs and volumes and mapping LUNs to initiator groups>>."
...
image:saphana_aff_fc_image10.png["Errore: Immagine grafica mancante"]
...
image:saphana_aff_fc_image11.png["Errore: Immagine grafica mancante"]
...
image:saphana_aff_fc_image12.jpg["Errore: Immagine grafica mancante"]
...
image:saphana_aff_fc_image13.jpeg["Errore: Immagine grafica mancante"]
...
image:saphana_aff_fc_image14.jpeg["Errore: Immagine grafica mancante"]
...
image:saphana_aff_fc_image15.jpeg["Errore: Immagine grafica mancante"]
...
image:saphana_aff_fc_image16.jpg["Errore: Immagine grafica mancante"]
...
image:saphana_aff_fc_image17.jpg["Errore: Immagine grafica mancante"]
...
+
image:saphana_aff_fc_image18.jpeg["Errore: Immagine grafica mancante"]

. Verificare che il provisioning dello storage sia stato eseguito correttamente.


image:saphana_aff_fc_image19.jpeg["Errore: Immagine grafica mancante"]
...
link:saphana_aff_fc_sap_hana_storage_connector_api.html["Successivo: API del connettore di storage SAP HANA."]
