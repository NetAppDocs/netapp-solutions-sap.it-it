...
Oltre alle attività descritte nella sezione, link:hana-fas-nfs-host-setup.html[""Host setup" (Configurazione host),"]è necessario creare punti di montaggio aggiuntivi e voci fstab per i nuovi volumi di dati aggiuntivi e montare i nuovi volumi.
...
....
image:saphana-fas-nfs_image19.png["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
