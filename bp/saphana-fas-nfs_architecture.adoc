...
link:saphana-fas-nfs_introduction.html["Precedente: Guida alla configurazione di SAP HANA su sistemi NetApp All Flash FAS con NFS."]

Gli host SAP HANA sono connessi ai controller di storage utilizzando un'infrastruttura di rete ridondante da 10 GbE o più veloce. La comunicazione dei dati tra gli host SAP HANA e i controller di storage si basa sul protocollo NFS. Si consiglia di utilizzare un'infrastruttura di switching ridondante per fornire una connettività host-to-storage SAP HANA fault-tolerant in caso di guasto dello switch o della scheda di interfaccia di rete (NIC). Gli switch potrebbero aggregare le performance delle singole porte con i canali delle porte in modo da apparire come una singola entità logica a livello di host.
...
image:saphana-fas-nfs_image2.png["Errore: Immagine grafica mancante"]

La figura seguente mostra un esempio di utilizzo di VMware vSphere come livello di virtualizzazione.

image:saphana-fas-nfs_image3.jpg["Errore: Immagine grafica mancante"]
...
image:saphana-fas-nfs_image4.png["Errore: Immagine grafica mancante"]
...
image:saphana-fas-nfs_image5.png["Errore: Immagine grafica mancante"]
...
image:saphana-fas-nfs_image6.jpg["Errore: Immagine grafica mancante"]
...
image:saphana-fas-nfs_image7.png["Errore: Immagine grafica mancante"]
...
image:saphana-fas-nfs_image8.png["Errore: Immagine grafica mancante"]

link:saphana-fas-nfs_storage_sizing.html["Successivo: Dimensionamento dello storage."]
