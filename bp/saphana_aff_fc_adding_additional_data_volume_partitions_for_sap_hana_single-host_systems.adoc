...
link:saphana_aff_fc_sap_hana_software_installation.html["Precedente: Installazione del software SAP HANA."]
...
link:saphana_aff_fc_where_to_find_additional_information.html["Avanti: Dove trovare ulteriori informazioni."]
