...
image::saphana_aff_nfs_image2.png[safana AFF nfs image2]

La figura seguente mostra un esempio di utilizzo di VMware vSphere come livello di virtualizzazione.

image::saphana_aff_nfs_image3.jpg[safana AFF nfs image3]
...
image::saphana_aff_nfs_image4.png[safana AFF nfs image4]
...
image::saphana_aff_nfs_image5.png[safana AFF nfs image5]
...
image::saphana_aff_nfs_image6.jpg[safana AFF nfs image6]
...
image::saphana_aff_nfs_image7.png[safana AFF nfs image7]
...
image::saphana_aff_nfs_image8.png[safana AFF nfs image8]
