...
link:saphana_fas_fc_architecture.html["Precedente: Architettura."]
...
image:saphana_fas_fc_image8.jpg["Errore: Immagine grafica mancante"]

link:saphana_fas_fc_infrastructure_setup_and_configuration_overview.html["Pagina successiva: Configurazione e configurazione dell'infrastruttura."]
