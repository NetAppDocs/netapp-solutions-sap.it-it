...
image:saphana_aff_nfs_image13.png["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:saphana_aff_nfs_image14.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:saphana_aff_nfs_image15.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:saphana_aff_nfs_image16.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
image:saphana_aff_nfs_image17.jpg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
