...
* link:../backup/hana-sc-vmware-smas-scope.html["Data Protection e high Availability di SAP HANA con SnapCenter, SnapMirror Active Sync e VMware Metro Storage Cluster"^]
