...
* FAS2750, FAS2820, FAS8300, FAS8700 E FAS9500. Un elenco completo delle soluzioni di storage certificate NetApp per SAP HANA è disponibile all'indirizzo https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=v:deCertified;ve:13["Directory hardware SAP HANA certificata e supportata"^].
...
image::saphana-fas-nfs_image1.png[safana FAS nfs image1]
