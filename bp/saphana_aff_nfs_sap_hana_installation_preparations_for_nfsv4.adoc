...
link:saphana_aff_nfs_host_setup.html["Precedente: Configurazione dell'host."]
...
....
link:saphana_aff_nfs_i_o_stack_configuration_for_sap_hana.html["Pagina successiva: Configurazione dello stack di i/o per SAP HANA."]
