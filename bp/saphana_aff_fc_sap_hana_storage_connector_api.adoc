...
link:saphana_aff_fc_storage_controller_setup.html["Precedente: Configurazione dello storage controller."]
...
link:saphana_aff_fc_host_setup.html["Avanti: Configurazione dell'host."]
