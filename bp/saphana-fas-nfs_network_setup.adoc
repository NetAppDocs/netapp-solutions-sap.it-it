...
image::saphana-fas-nfs_image10.png[safana FAS nfs image10]
...
image::saphana-fas-nfs_image11.png[safana FAS nfs image11]
...
image::saphana-fas-nfs_image12.png[safana FAS nfs image12]
