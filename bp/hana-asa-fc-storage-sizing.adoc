...
Un SSD NVMe (dati) supporta fino a 2/5 host SAP HANA a seconda del disco NVMe specifico utilizzato.
...
image:saphana_asa_fc_image8a.png["Processo di dimensionamento di SAP HANA"]
