...
Il numero minimo di SSD NVMe da 12 GB per il primo shelf supporta fino a 18 host SAP HANA. Uno shelf completamente popolato (24 SSD) supporta fino a 48 host SAP HANA. Lo stesso vale per i dischi interni di un sistema AFF A800.
