...
link:saphana_aff_nfs_sap_hana_data_volume_size.html["Precedente: Dimensione del volume di dati SAP HANA."]
...
link:saphana_aff_nfs_adding_additional_data_volume_partitions.html["Avanti: Aggiunta di partizioni di volumi di dati aggiuntive."]
