...
NOTE: NetApp ASA systems non supportano NFS come protocollo. NetApp consiglia di utilizzare un sistema AFF o FAS per i  `/hana/shared` e  `/lss/shared` file system.
