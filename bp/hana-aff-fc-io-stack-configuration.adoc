...
summary: A partire da SAP HANA 1.0 SPS10, SAP ha introdotto parametri per regolare il comportamento I/O e ottimizzare il database per il file system e il sistema storage utilizzati. 
---
