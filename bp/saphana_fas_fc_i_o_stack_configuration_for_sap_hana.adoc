...
link:saphana_fas_fc_host_setup.html["Precedente: Configurazione dell'host."]
...
....
link:saphana_fas_fc_sap_hana_software_installation.html["Successivo: Installazione del software SAP HANA."]
