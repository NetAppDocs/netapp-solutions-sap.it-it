...
link:saphana_fas_fc_storage_controller_setup.html["Precedente: Configurazione dello storage controller."]
...
link:saphana_fas_fc_host_setup.html["Avanti: Configurazione dell'host."]
