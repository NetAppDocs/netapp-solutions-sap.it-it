...
link:saphana_fas_fc_adding_additional_data_volume_partitions_for_sap_hana_single-host_systems.html["Precedente: Aggiunta di partizioni di volumi di dati aggiuntive per sistemi SAP HANA a host singolo."]
...
link:saphana_fas_fc_update_history.html["Pagina successiva: Aggiornare la cronologia."]
